        ...
        `
            <div class="icPanel">
                ...
                <div class="options">
                    ...
                    <button class="button"><a class="linkButton" href="https://suportedti.agu.gov.br/otrs/index.pl?Action=AgentLinkObject;SourceObject=Ticket;SourceKey=${ticket}&AddIc" target="_blanck">Inserir manual</a></button>
                </div>
            </div>
            `
      );
