...
export function AddTeamsLink() {
    ...
    let link = `https://teams.microsoft.com/l/chat/0/0?users=${userEmail}&message=${greeting} Sr(a) ${userName}! Meu nome é ${tecName}, Técnico de Suporte da Empresa Hepta. O motivo do meu contato é referente ao Chamado ${numChamado}, com assunto: ${subject}.`
    link.replaceAll(' ', '%20')
    a.href = link
